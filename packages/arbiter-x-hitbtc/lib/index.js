...
var _NotificationHandler = require('./handlers/NotificationHandler');
...
var baseUrl = 'wss://api.hitbtc.com/api/2/ws';
...
var ArbiterExchangeHitBTC = function () {
	function ArbiterExchangeHitBTC() {
		...
		var notificationHandler = new _NotificationHandler2.default(this.event);
		...
		wsClient.on('message', function (resp) {
			...
			if (notificationHandler.evaluate(respJSON)) return;
